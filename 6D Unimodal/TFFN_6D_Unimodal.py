...
if __name__ == "__main__":
    ...
    # Save
    torch.save(model, model_path + '/TFFN_6D_Unimodal.pth')
    np.save(model_path + '/TFFN_6D_Unimodal_results.npy', model.results, allow_pickle=True)
    np.save(model_path + '/TFFN_6D_Unimodal_plot.npy', model.plot, allow_pickle=True)
